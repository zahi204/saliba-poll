...
<img class="round" src="{{asset('images/portrait/small/logomet.jpeg') }}" alt="avatar" height="80"  />
...
<div style="margin-top:150px; margin-right:150px;margin-right:200px;" class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
